...
trainloader, valloader, testloader, trainall, d_train, d_vali, d_test = split_data(df, target, predictors, latents,x, batchsize=1000, f=0.8, v=0.1, shuffle=true, partial=true)
